          ...
          data.forEach(a => {
            proCards+=`
               <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                  <div style="border-radius: 15px; height:550px; background-color :  #1d3557;" class="project-card m-3">
                  <img width='100%' height="300px"style="border-radius: 15px 15px 0 0;" src="images/${a.img}"  alt="pic">
                  <h3 style="color:  #a8dadc;" class="ms-2 mt-2 text-capitalize">${a.title}</h3>
                  <p style="color: #a8dadc; text-align:justify; word-spcinf:1;"class="mx-2 mt-3 text-capitalize">${a.description}</p>
                  <a href="${a.one}" style="font-size:20px; color:  #a8dadc; "class="btn text-capitalize mx-2 my-1 fw-bold"><i class="fa-solid fa-link me-1"></i>${a.button}</a>
                  <a href="${a.two}" style="font-size:20px; color:  #a8dadc;" class="btn text-capitalize mx-2 my-1 fw-bold"><i class="fa-brands fa-github me-1"></i>${a.button1}</a>
            </div>
          </div>
            `;
